...
import { AboutPageAttributes, AboutPageResponse } from '@/types/aboutPageTypes';
import ImageContainer from '@/components/panels/ImageContainer';
import RichTextEditor from '@/components/RichTextEditor';
import MainGrid from '@/components/layout/MainGrid';

const AboutPage = async () => {
  const response: AboutPageResponse = await fetchStrapiContent(
  ...
  const data: AboutPageAttributes = response.data.attributes;
